...
func NewMovFnAggregation(bucketsPath string, script *elastic.Script, window int) *MovFnAggregation {
	a := &MovFnAggregation{
...
func (a *MovFnAggregation) Script(script *elastic.Script) *MovFnAggregation {
	a.script = script
	return a
}
