...
func (a *CompositeAggregationTermsValuesSource) Script(script *elastic.Script) *CompositeAggregationTermsValuesSource {
	a.script = script
	return a
}
...
// Script to use for this source.
func (a *CompositeAggregationHistogramValuesSource) Script(script *elastic.Script) *CompositeAggregationHistogramValuesSource {
	a.script = script
	return a
}
...
// Script to use for this source.
func (a *CompositeAggregationDateHistogramValuesSource) Script(script *elastic.Script) *CompositeAggregationDateHistogramValuesSource {
	a.script = script
	return a
}
