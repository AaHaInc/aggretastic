...
func setupTestClient(t logger, options ...elastic.ClientOptionFunc) (client *elastic.Client) {
	var err error
...
func setupTestClientAndCreateIndex(t logger, options ...elastic.ClientOptionFunc) *elastic.Client {
...
func setupTestClientAndCreateIndexAndLog(t logger, options ...elastic.ClientOptionFunc) *elastic.Client {
	return setupTestClientAndCreateIndex(t, elastic.SetTraceLog(log.New(os.Stdout, "", 0)))
}

func setupTestClientAndCreateIndexAndAddDocs(t logger, options ...elastic.ClientOptionFunc) *elastic.Client {
...
func setupTestClientAndCreateIndexAndAddDocsNoSource(t logger, options ...elastic.ClientOptionFunc) *elastic.Client {
	client := setupTestClientAndCreateIndex(t, options...)
...
func setupTestClientForXpackSecurity(t logger) (client *elastic.Client) {
	var err error
	// Set URL and Auth to use the platinum ES cluster
	options := []elastic.ClientOptionFunc{elastic.SetURL("http://127.0.0.1:9210"), elastic.SetBasicAuth("elastic", "elastic")}
